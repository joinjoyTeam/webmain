...
function GroupFilters({ groups, selectedGroup, onSelect }) {
  return (
    ...
    <div className="flex justify-center">
      <span className="justify-center focus:outline-none focus:ring-0 inline-flex items-center gap-1 rounded-xl bg-[#1877F2] px-5 py-2 text-base font-semibold text-white shadow-md shadow-[#1877F2]/30 transition ">
